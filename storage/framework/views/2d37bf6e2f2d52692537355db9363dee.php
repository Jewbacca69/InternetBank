...
$__html = app('livewire')->mount($__name, $__params, 'IKUCyOc', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <footer class="footer footer-center p-4 bg-gray-900">
            <aside>
                <p>Copyright © 2023 - All right reserved by ShitBanking</p>
            </aside>
        </footer>
    </body>
</html>
<?php /**PATH G:\Projects\InternetBank\resources\views/layouts/app.blade.php ENDPATH**/ ?>