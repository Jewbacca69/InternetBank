<dialog id="createAccount" class="modal">
    <div class="modal-box">
        ...
        <form action="<?php echo e(route("accounts.store")); ?>" method="post" class="p-4">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Vilnis\test\InternetBank\resources\views/modals/create-account.blade.php ENDPATH**/ ?>